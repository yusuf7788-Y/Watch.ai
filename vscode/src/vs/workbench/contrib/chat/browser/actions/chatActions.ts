...
MenuRegistry.appendMenuItem(MenuId.CommandCenter, {
	...
	title: localize('title4', "Watch.ai"),
	icon: { dark: URI.file('C:/Watch.ai/logo-beyaz.png'), light: URI.file('C:/Watch.ai/logo-beyaz.png') },
...
export class CopilotTitleBarMenuRendering extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		const disposable = actionViewItemService.register(MenuId.CommandCenter, MenuId.ChatTitleBarMenu, (action, options, instantiationService, windowId) => {
			...
			let primaryActionId = 'watch-ai.askKat';
			let primaryActionTitle = localize('openWatchAI', "Open Watch.ai");
			let primaryActionIcon = { dark: URI.file('C:/Watch.ai/logo.png'), light: URI.file('C:/Watch.ai/logo.png') };
